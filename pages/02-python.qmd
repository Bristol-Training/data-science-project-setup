...
PowerShell as an administrator. To do this, search for "PowerShell" in the start menu, right-click it, and select "Run as administrator". Then enter the following command:
...
For the "Introduction to Data Analysis in Python" course (see [here](https://bristol-training.github.io/introduction-to-data-analysis-in-python/)), you would need the `pandas` and `seaborn` package. You can add these with:
